...
insert into user(identifier, last_task_num, name, task_start_idx, task_end_idx) values('C', 1, '김이랴', 1, 120);
...
insert into user(identifier, last_task_num, name, task_start_idx, task_end_idx) values('F', 1, '전은하', 1, 120);
...
# insert into assignment(similar_instruct1, similar_instruct2, input, output, task_id, user_id) values("similar_instruct03", "similar_instruct03", "", "", 3, 1);
